...
const DOMAIN_NAME = "homophilyhub.com";
const IP_ADDRESS = "167.172.37.85";
...
// Login Route
app.get('/login', isLoggedInMiddleware(), function (req, res) {
	res.render('login', {
	    domainName: DOMAIN_NAME
	});
});
	...
	fs.appendFile('history.txt', '\n\n'+year + "-" + month + "-" + date + " " + hours + ":" + minutes + ":" + seconds+"\n"+email+"\nLOGIN_EMAIL_SENT", (err) => {
	    if (err) throw err;
                                ...
                                let mailOptions = {
                                    ...
                                    subject: 'HomophilyHub', // Subject line
...
//	req.flash('danger', 'Your login expired, please re-verify.');
	res.send('Sorry, invalid or expired token. Please <a href="/">go back</a> and re-enter your email address.');
    }
});
						...
						fs.appendFile('history.txt', '\n\n'+year + "-" + month + "-" + date + " " + hours + ":" + minutes + ":" + seconds+"\n"+email+"\n"+matchEmail+"\nMATCHED\n"+yourContact+"\n"+matchContact+"\n"+distance123+commonTagsHistoryTxtString, (err) => {
						    if (err) throw err;
                		                ...
                		                let mailOptions = {
                                		    from: '"Geofree Tze" <'+EMAIL_ADDRESS+'>', // sender address
                		                    to: EMAIL_ADDRESS, // list of receivers
                                		    subject: 'HomophilyHub: you both swiped right!', // Subject line
		                                    text: '', // plain text body
                		                    html: 
							...
							'<br>' + 
							'Thanks for using <a href="https://homophilyhub.com/" target="_blank">HomophilyHub.com</a> 🙂<br>' + 
							'<br>' +
							'<br>' +
							'<br>' +
							'<br>' +
					...
					neo4j_session
						...
						friendRequestEmail: friendRequestEmail
                	                ...
                	                let mailOptions = {
                        	            from: '"Geofree Tze" <'+EMAIL_ADDRESS+'>', // sender address
	                                    to: EMAIL_ADDRESS, // list of receivers
        	                            subject: 'HomophilyHub: ' + friendRequestEmail + ' wants to break the ice with' + email, // Subject line
                	                    text: '', // plain text body
						...
						fs.appendFile('history.txt', '\n\n'+year + "-" + month + "-" + date + " " + hours + ":" + minutes + ":" + seconds + "\n" + email + "\n" + friendRequestEmail + "\nICEBREAKER_REQUEST_ACCEPTED_BUT_NOTHING_IN_COMMON", (err) => {
						    if (err) throw err;
                		                ...
                		                let mailOptions = {
                                		    from: '"Geofree Tze" <'+EMAIL_ADDRESS+'>', // sender address
		                                    to: EMAIL_ADDRESS, // list of receivers
                                		    subject: 'HomophilyHub: well this is awkward...', // Subject line
		                                    text: '', // plain text body
                		                    html: 
						...
						fs.appendFile('history.txt', '\n\n'+year + "-" + month + "-" + date + " " + hours + ":" + minutes + ":" + seconds + "\n" + email + "\n" + friendRequestEmail + "\nICEBREAKER_REQUEST_ACCEPTED" + commonTagsHistoryTxtString, (err) => {
						    if (err) throw err;
                		                ...
                		                let mailOptions = {
                                		    from: '"Geofree Tze" <'+EMAIL_ADDRESS+'>', // sender address
		                                    to: EMAIL_ADDRESS, // list of receivers
                                		    subject: 'HomophilyHub: Icebreaker Request accepted!', // Subject line
		                                    text: '', // plain text body
                		                    html: 
							'Here\'s your commonalities and values:' +
							commonTagsEmailString + '<br>' + 
